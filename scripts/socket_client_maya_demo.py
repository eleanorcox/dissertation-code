...
joint_pos_strings = np.ndarray(clip_frames, dtype=object)
xz_vel_strings    = np.ndarray(clip_frames, dtype=object)
for i in range(clip_frames):
    joint_pos_strings[i] = formatData(joint_pos_clips[i])
    xz_vel_strings[i]    = formatData(xz_vel_clips[i])
